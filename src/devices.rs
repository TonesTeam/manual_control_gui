...
pub static PP02_SPEC: Spec = Spec {
    ...
    model: "Runze SY-08 syringe pump, 0.9° stepper, single hole, 5 mL, integrated driver",
    source: "Runze SY-08 manual (manuals.plus) / controller_v2 calibration",
    source_url: "https://manuals.plus/runze/sy-08-syringe-pump-manual",
    rows: &[
        ("Syringe", "5 mL, single hole, female thread"),
        ("Motor", "0.9° stepper"),
        ("Full stroke (as used)", "12000 steps (controller_v2)"),
        ("Resolution (as used)", "0.416 µL/step (controller_v2)"),
        ("Interface", "RS232 / RS485 / CAN, same 0xCC…0xDD frame"),
        ("Baud rate", "9600 (default) … 115200 bps"),
    ],
    notes: &[
        "The full SY-08 datasheet could not be downloaded (403); stroke and resolution come from controller_v2 and agree with 5 mL.",
    ],
};
